(module
 ...
 (global $assembly/index/gray (mut i32) (i32.const 0))
 (global $assembly/index/inverted (mut i32) (i32.const 0))
 ...
 (export "toGray" (func $export:assembly/index/toGray))
 (export "toInverted" (func $export:assembly/index/toInverted))
 (start $~start)
 ...
 (func $assembly/index/toGray (param $data i32) (param $width i32) (param $height i32) (param $gray i32) (result i32)
  (local $arr i32)
  (local $l i32)
  (local $i i32)
  (local $x f64)
 ...
 (func $assembly/index/toInverted (param $data i32) (param $width i32) (param $height i32) (param $inverted i32) (result i32)
  (local $arr i32)
  (local $l i32)
  (local $i i32)
  (local $j i32)
 ...
 (func $export:assembly/index/toGray (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  (local $4 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $export:assembly/index/toInverted (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  (local $4 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  local.get $2
  local.get $3
  call $assembly/index/toInverted
  local.set $4
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
